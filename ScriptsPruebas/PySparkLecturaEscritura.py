...
padron_df.write.format("parquet").mode("overwrite").save("hdfs://192.168.10.62:9000/carlos/outPy/PadronParquet")

# Guardar en formato json
padron_df.write.format("json").mode("overwrite").save("hdfs://192.168.10.62:9000/carlos/outPy/PadronJson")